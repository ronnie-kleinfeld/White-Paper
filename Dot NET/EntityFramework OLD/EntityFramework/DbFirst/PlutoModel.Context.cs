...
namespace DbFirst
{
    ...
    public partial class PlutoDbContext : DbContext
    {
        ...
        public virtual ObjectResult<GetCourses_Result1> GetCourses()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCourses_Result1>("GetCourses");
        }
