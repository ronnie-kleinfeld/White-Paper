...
public class Strings3 {
        ...
        public static void main(String[] args) {
                ...
                System.out.println("maximumDifferenceBetweenDigits(abc): " + maximumDifferenceBetweenDigits("abc"));
                System.out.println("maximumDifferenceBetweenDigits(a1): " + maximumDifferenceBetweenDigits("a1"));
                ...
                System.out.println("maximumDistanceBetweenLetters(1ab): " + maximumDistanceBetweenLetters("1ab"));
                System.out.println("maximumDistanceBetweenLetters(1a): " + maximumDistanceBetweenLetters("a"));
                System.out.println("maximumDistanceBetweenLetters(11): " + maximumDistanceBetweenLetters("11"));

                System.out.println("\nEx3: isSubString");
                System.out.println("isSubString(dafna, afna): " + isSubString("dafna", "afna"));
                System.out.println("isSubString(dafna, afnda): " + isSubString("dafna", "afnda"));
                System.out.println("isSubString(dafna, \"\"): " + isSubString("dafna", ""));
