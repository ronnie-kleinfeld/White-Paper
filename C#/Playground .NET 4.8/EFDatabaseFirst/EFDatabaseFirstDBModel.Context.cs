...
namespace EFDatabaseFirst
{
    ...
    public partial class EFDatabaseFirstDBDBContext : DbContext
    {
        public EFDatabaseFirstDBDBContext()
            : base("name=EFDatabaseFirstDBDBContext")
        {
        }
        ...
        [DbFunction("EFDatabaseFirstDBDBContext", "funcGetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> funcGetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[EFDatabaseFirstDBDBContext].[funcGetAuthorCourses](@AuthorID)", authorIDParameter);
        }
